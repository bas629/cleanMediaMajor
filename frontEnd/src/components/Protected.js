...
function Protected() {
    ...
    const [flag, setFlag] = useState(false);
     const{savePost,changeHandler, PrivateFriend,ProtectedFriend,AddFriend,getPublicPost,ProtectedtPost,
      protectedPost}=useContext(ContextApp)
  ...
  return (
    ...
    <div className="sticky bottom-0 h-12 bg-black border-t-2 border-blue-700 z-40">
      <ul className="flex justify-around items-center h-full space-x-4 text-white">
        ...
        <img src="https://res.cloudinary.com/dw3gaixoh/image/upload/v1728747295/rivicypojj0nz7syxeh2.png" className="w-14  bg-slate-400  h-12"></img>
        </NavLink>
      </ul>
    </div>
  </div>
